...
export default function SettingsScreen() {
  ...
  return (
    <ScreenContainer className="flex-1 bg-gray-900">
      <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
        <View className="p-6 gap-6">
          ...
          <View className="flex-row items-center justify-between mb-4">
            ...
            >
              <Text className="text-lg text-blue-400">Done</Text>
            </Pressable>
          </View>
                  ...
                  style={({ pressed }) => [
                    {
                      ...
                      borderRadius: 12,
                      borderWidth: settings.backgroundColor === color.value ? 3 : 0,
                      borderColor: "#00ffff",
          ...
          {/* Time Color Section */}
          <View className="gap-3">
            <Text className="text-xl font-semibold text-white">Time Color</Text>
            <View className="flex-row flex-wrap gap-3">
                  ...
                  style={({ pressed }) => [
                    {
                      ...
                      backgroundColor: color.value,
                      borderRadius: 12,
                      borderWidth: settings.timeColor === color.value ? 3 : 0,
                      borderColor: "#ffffff",
                      opacity: pressed ? 0.8 : 1,
                    },
                  ]}
